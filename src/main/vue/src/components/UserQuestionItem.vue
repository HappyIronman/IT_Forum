    ...
    <div class="uk-card uk-card-default uk-margin-left uk-margin-right uk-margin-top">
        ...
        <div class="uk-grid-small uk-flex-middle uk-margin-remove" uk-grid>
          ...
          <div class="uk-width-auto">
            <h5 class="uk-card-title uk-margin-remove-bottom">
              <router-link v-bind:to="'/user/'+question.userId">
                {{question.username}}
              </router-link>
            </h5>
      ...
      <div class="uk-card-body uk-padding-small">
        <p class="uk-margin-small">
          <router-link class="uk-text-bold" v-bind:to="'/user/'+
         question.userId+'/question/' + question.uniqueId">
            {{question.title}}
          </router-link>
        </p>
      ...
      <div class="uk-card-footer uk-padding-remove uk-text-right">
        <router-link class="uk-text-small uk-margin-right" v-bind:to="'/user/'+
         question.userId+'/question/' + question.uniqueId">
          <span>回答</span>
